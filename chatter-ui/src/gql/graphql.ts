...
export type ChatFragmentWithLastMessageFragment = { __typename?: 'ChatDocumentWithLastMessage', _id: string, createdBy: string, isPrivate: boolean, isGroup: boolean, userIds: Array<string>, name?: string | null, deleted: boolean, createdAt: any, lastMessage?: { __typename?: 'LastMessage', _id: string, content: string, createdAt: any, updatedAt: any, deleted: boolean, chat: string, user: { __typename?: 'UserLastMessage', _id: string, username: string } } | null };
...
export type SearchUsersFragmentFragment = { __typename?: 'SearchUser', _id: string, username: string, email: string, isOnline: boolean, lastConnection: any };
...
export type GetChatQuery = { __typename?: 'Query', chat?: { __typename?: 'ChatDocumentWithLastMessage', _id: string, createdBy: string, isPrivate: boolean, isGroup: boolean, userIds: Array<string>, name?: string | null, deleted: boolean, createdAt: any, lastMessage?: { __typename?: 'LastMessage', _id: string, content: string, createdAt: any, updatedAt: any, deleted: boolean, chat: string, user: { __typename?: 'UserLastMessage', _id: string, username: string } } | null } | null };
...
export type SearchUsersQuery = { __typename?: 'Query', searchUsers: Array<{ __typename?: 'SearchUser', _id: string, username: string, email: string, isOnline: boolean, lastConnection: any }> };
